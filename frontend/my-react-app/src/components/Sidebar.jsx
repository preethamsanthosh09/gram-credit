...
export const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'KYC Verify', path: '/kyc', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
    { name: 'Crop Loans', path: '/loans', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
    { name: 'Transactions', path: '/transactions', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
    { name: 'ROSCA / Chit Fund', path: '/rosca', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 1121.21 7.89M9 11l3 3L22 4' },
    { name: 'Saathi Assistant', path: '/chat', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
    { name: 'Vendor Finance', path: '/vendors', icon: '🏪' },
  ];
    ...
    <aside className="w-60 h-screen bg-green-900 text-white fixed top-0 left-0 flex flex-col justify-between p-5 z-20 shadow-2xl">
      ...
      <div>
        <div className="flex items-center gap-3 mb-8 cursor-pointer" onClick={() => navigate('/dashboard')}>
          <svg className="w-8 h-8 text-green-300" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M32 4C18 12 14 26 14 40C14 48.8 20.2 56 32 60C43.8 56 50 48.8 50 40C50 26 46 12 32 4Z" fill="currentColor" />
            <path d="M32 18V46M24 36H40M27 26H37" stroke="#166534" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <span className="text-xl font-extrabold tracking-wide">GramCredit</span>
        </div>
      ...
      <div className="border-t border-green-800 pt-4 mt-auto">
        {user ? (
          ...
          <div className="mb-4 bg-green-950/40 p-3.5 rounded-xl border border-green-800/50">
            <p className="text-sm font-bold text-green-300">Farmer Session</p>
            <p className="text-xs text-green-200/50">Not logged in</p>
          </div>
        )}
